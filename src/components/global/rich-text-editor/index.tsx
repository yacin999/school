        ...
        <EditorRoot>
          <EditorContent
            ...
            onUpdate={({ editor }) => {
              ...
              console.log("from BLOCK TEXT EDITor (html) :", setContent, setTextContent)
              if (setHtmlContent) {
                setHtmlContent(html)
              }
              console.log("from BLOCK TEXT EDITor (text) :", text)
              console.log("from BLOCK TEXT EDITor (json) :", json)
              setContent(json)
              setTextContent(text)
